...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.computeTitle = function (dateProfile) {
        ...
        }, dateProfile.isRangeAllDay, this.opt('titleFormat') || this.computeTitleFormat(dateProfile), this.opt('titleRangeSeparator'),dateProfile);
    };
...
*/
function formatRange(date1, date2, formatStr, separator, isRTL,dateProfile) {
    ...
    return renderParsedFormat(getParsedFormatString(formatStr), date1, date2, separator || ' - ', isRTL,dateProfile);
}
exports.formatRange = formatRange;
/*
Renders a range with an already-parsed format string.
*/
function renderParsedFormat(parsedFormat, date1, date2, separator, isRTL,dateProfile) {
...
var DateComponent = /** @class */ (function (_super) {
    ...
    DateComponent.prototype.formatRange = function (range, isAllDay, formatStr, separator,dateProfile) {
        var end = range.end;
        if (isAllDay) {
            end = end.clone().subtract(1); // convert to inclusive. last ms of previous day
        }
        return date_formatting_1.formatRange(range.start, end, formatStr, separator, this.isRTL,dateProfile);
    };
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.bindViewHandlers = function (view) {
        ...
        view.watch('titleForCalendar', ['title'], function (deps) {
            if (view === _this.view) {
                _this.setToolbarsTitle(deps.title,view.type);
            }
        });
    ...
    Calendar.prototype.setToolbarsTitle = function (title,type) {
		let reg=new RegExp('undefined','g')
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        if (view.isMultiDayRange(componentFootprint.unzonedRange)) {
            ...
            timeText = this.getTimeText(seg.footprint, 'LT');
